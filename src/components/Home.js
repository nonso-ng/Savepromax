    ...
    <section>
      ...
      <section className="first-section">
        <div className="first-section-left">
          <h1>
            Welcome Back <span> {username}</span> <br /> Join <span>our</span>{" "}
            happy customers download our <span> app!!</span>
          </h1>
          <p>
            Give all your customers global freedom with just a tap of their
            cards
          </p>
      ...
      <section className="second-section">
        ...
        <div className="second-section-right">
          <h1>
            ...
            <br /> we have a lock savings
            <br /> feature
          </h1>
          <p>
            The best customer experience you are going to have, features <br />
            that suit your business savings plan and savepro is also for all
            <br /> age group
          </p>
